# 🚀 Sparky Flutter Client - Complete Migration Plan
...
#### 🔄 **HYBRID** (Client + Server Collaboration)
...
│                                                         │
│  ┌─────────────────┐  ┌──────────────────┐            │
│  │ Wake Word (FFI) │  │ UI/State Mgmt    │            │
│  │ - openWakeWord  │  │ - Provider/Bloc  │            │
│  │ - Local only    │  │ - Flutter widgets│            │
│  └─────────────────┘  └──────────────────┘            │
│                                                         │
│  ┌─────────────────┐  ┌──────────────────┐            │
│  │ Audio I/O       │  │ System Tray      │            │
│  │ - Record mic    │  │ - Tray menu      │            │
│  │ - Play speaker  │  │ - Notifications  │            │
│  └─────────────────┘  └──────────────────┘            │
│                                                         │
│  ┌───────────────────────────────────────┐            │
│  │ WebSocket Client                       │            │
...
└────────────────────┬────────────────────────────────────┘
                     ...
                     │
┌────────────────────▼────────────────────────────────────┐
│  ORCHESTRATOR (Python) - ENHANCED                       │
│                                                         │
│  ┌─────────────────┐  ┌──────────────────┐            │
│  │ VAD Module      │  │ Echo Cancellation│            │
│  │ - webrtcvad     │  │ - speexdsp       │            │
│  │ - Silence detect│  │ - AEC processing │            │
│  └─────────────────┘  └──────────────────┘            │
│                                                         │
│  ┌───────────────────────────────────────┐            │
...
#### **Phase 2: Client-Side via FFI (1-2 Weeks Later)** ⭐ **FUTURE OPTIMIZATION**
...
- ✅ Works offline
- ✅ Lower power (no network)

**Cons:**
- ⚠️ Need to convert openWakeWord models to TFLite format
- ⚠️ More complex client
- ⚠️ Model updates require app rebuild
...
## 🗺️ Feature Mapping: PyQt6 → Flutter
...
## 🛡️ Mitigation Strategies for Flutter Cons
...
1. **Server-Side Processing** ⭐ **PRIMARY STRATEGY**
   - Keep heavy Python logic on server
   - Client is thin UI layer
   - Example: OCR → server-side, not client
...
- ✅ Easy updates (replace folder)

**Cons:**
- ⚠️ Larger download (includes all dependencies)
...
**Cons:**
- ⚠️ Requires code signing certificate ($100-500/year)
...
- ✅ Text chat works (send/receive messages)
- ✅ Can connect to orchestrator
- ✅ Basic UI looks good

### Phase 2 Complete When:
- ✅ Voice recording works
- ✅ Audio playback works
- ✅ Full voice conversation flow functional
...
2. **Build client in phases** (text → audio → tray → polish)
